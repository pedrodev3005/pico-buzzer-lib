// EXEMPLO_BUZZER_MELODY_NO_INTERRUPTION
...
int main() {
    ...
    buzzer_melody_no_interruption(&buzzer1, melody_notes, melody_durations, melody_length);

    while (true) {
        // Seu código principal só irá rodar após o termino da função melody_no_interruption
